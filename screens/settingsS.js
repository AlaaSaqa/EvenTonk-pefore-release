...
LogBox.ignoreAllLogs();
  ...
  const [item,setItem] =useState(route.params);
    ...
    const [phoneC,setPhoneC]=useState(false);
  ...
  fetch("http://10.0.2.2:4000/signInS")
    ...
    .then(results=>{
       for (let i =0;i<results.length;i++){
         ...
         navigation.replace('studentProfile',results[i]);
         }
       }
    })
}
       ...
       {nameC&&(
        ...
        <TextInput
            ...
            ,width:'90%',height:50,alignSelf:'center',marginBottom:'5%'}} onPress={()=> {setNameC(!nameC);
              fetch("http://10.0.2.2:4000/update-signInS",{
                method :"post",
                headers:{
      ...
      //  marginBottom:'5%'
       ...
       {phoneC&&(
        ...
        <TextInput
            ...
            />
            <TouchableOpacity style={{ borderRadius:25, backgroundColor:COLORS.white,alignContent:'center',justifyContent:'center'
            ,width:'90%',height:50,alignSelf:'center',marginBottom:'5%'}} onPress={()=> {setPhoneC(!phoneC)
              fetch("http://10.0.2.2:4000/update-signInS",{
                method :"post",
                headers:{
                    'Content-Type':'application/json'
