...
if (number.length!=8){
   ...
   if (password.length<8){
    ...
    if (password==confirmPassword){
        ...
        fetch("http://10.0.2.2:4000/send-data-student",{
        method :"post",
        headers:{
    ...
    .then (data=>{
        console.log(data);
        fetch("http://10.0.2.2:4000/send-data-studentComms",{
            method :"post",
            headers:{
                'Content-Type':'application/json'
            },
        ...
        fetch("http://10.0.2.2:4000/send-data-joinedEvents",{
            method :"post",
            headers:{
                'Content-Type':'application/json'
            },
        ...
        fetch("http://10.0.2.2:4000/send-data-starEvents",{
            method :"post",
            headers:{
                'Content-Type':'application/json'
            },
        ...
        fetch("http://10.0.2.2:4000/send-data-likedCommPosts",{
            method :"post",
            headers:{
                'Content-Type':'application/json'
            },
        ...
        fetch("http://10.0.2.2:4000/send-data-likedEventPosts",{
            method :"post",
            headers:{
                'Content-Type':'application/json'
            },
